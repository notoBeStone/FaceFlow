...
@objc public protocol Vip27617AContentViewDelegate: PurchaseTrailReminderDelegate {
    func closeAction()
    func startAction(_ type: Price27617Type)
...
@objc
public class Vip27617AContentView: UIView {
    private weak var delegate: Vip27617AContentViewDelegate?
    private let languageType: GLLanguageEnum
    
    @objc
    public init(extra: [AnyHashable: Any]?, delegate: Vip27617AContentViewDelegate) {
    ...
    func localized(key: String) -> String {
        key.localized(for: self.classForCoder, tableName: "Localizable27617")
    }
    ...
    @objc public static var skuIds: [String] {
        Price27617Type.allCases.map {$0.skuId}
    }
    ...
    private var priceType: Price27617Type {
    ...
    private lazy var featureView: UIStackView = {
        ...
        for feature in features {
            ...
            let icon = UIImageView(image: UIImage.imageOrMain("feature_27616", for: Vip27617AContentView.classForCoder()))
...
extension String {
    func vipLocalized(for aClass: AnyClass? = Vip27617AContentView.self, tabName: String = "Localizable27617") -> String {
